import { PrismaClient, RoleType, ProjectCategoryType, Prisma } from '@prisma/client';
...
main()
  .catch((error: unknown) => {
    if (error instanceof Prisma.PrismaClientInitializationError) {
      console.error('\nDatabase connection failed during seed.');
      console.error('Check DATABASE_URL in your .env file and verify username/password/host/port.');
    }
